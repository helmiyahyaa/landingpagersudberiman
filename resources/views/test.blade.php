...
<div class="dev-popup" id="devPopup">
    <div class="popup-content">
        ...
        <p>Maaf, fitur appointment saat ini sedang dalam tahap pengembangan. Kami akan segera menghadirkan layanan ini untuk Anda.</p>
        {{-- <img src="assets/img/under-construction.svg" alt="Dalam Pengembangan" class="popup-image"> --}}
    </div>
</div>

<!-- Tambahkan script ini -->
<script>
    // Ganti kode event listener dengan ini:
document.querySelector('.appointment-submit-button').addEventListener('click', function(e) {
    e.preventDefault();
...
window.addEventListener('click', function(e) {
    if (e.target === document.getElementById('devPopup')) {
        e.preventDefault();
        document.getElementById('devPopup').style.display = 'none';
    }
});
