        ...
        <div class="table-responsive shadow rounded-3 p-3 bg-white">
            <table id="informasiTable" class="table table-hover table-striped align-middle mb-0">
                ...
                <tbody>
                    ...
                    @forelse ($semua_konten as $index => $regulasi)
                        <td>{{ $index + 1 }}</td>
                            <td class="fw-semibold">{{ $regulasi->judul }}</td>
                            <td class="text-center">
                                <a href="{{ $regulasi->link }}" target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-primary">
                                    Lihat Dokumen
                                </a>
                            </td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="3" class="text-center text-muted py-4">
                                Belum ada data regulasi yang tersedia.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
